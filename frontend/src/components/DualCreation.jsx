...
export default function DualCreation({ onBuildClick, onAIClick }) {
  ...
  return (
    <section id="dual-creation" className="relative py-24 px-4">
      ...
      <div ref={ref} className={`max-w-5xl mx-auto ${isVisible ? 'reveal' : 'opacity-0'}`}>
        ...
        <div
          className="gradient-border rounded-2xl bg-void-card p-6 sm:p-8 md:p-10 transition-all duration-300"
          style={{
        ...
        >
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
            <div>
              ...
              <button
                onClick={() => (activePath === 'manual' ? onBuildClick && onBuildClick() : onAIClick && onAIClick())}
